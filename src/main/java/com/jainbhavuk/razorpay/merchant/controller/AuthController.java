...
public class AuthController {
    ...
    @PostMapping("/signup")
    private ResponseEntity<MerchantSignupResponse> signup(@RequestBody @Valid MerchantSignupRequest request){
    ...
    @PostMapping("/login")
    private ResponseEntity<LoginResponse> login(@RequestBody @Valid LoginRequest request){
